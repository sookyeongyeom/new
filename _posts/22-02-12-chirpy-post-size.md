...
심플하면서도 필요한 기능은 다 들어가있기 때문인지 깃헙 블로그에서 자주 보이는 테마다.

테마를 커스터마이징하면서 아쉬웠던 점은 전체 포스팅 개수를 보여주는 방법을 안내하지 않는다는 것이었다.
...
템플릿 문법 자체를 처음 다뤄보기도 하고, 단서를 바탕으로 객체를 역으로 파악하느라 구현하는 건 한참 헤맸지만...
