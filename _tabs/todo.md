...
<table>
    ...
    <tbody>
        <tr>
            <td>
                <input type=checkbox >ㅤ절대강좌 유니티 CH3<br>
                <input type=checkbox >ㅤ오후 7시 저녁 약속 분당<br>
            </td>
            <td>
...
<table>
    ...
    <tbody>
        <tr>
            <td>
                <input type=checkbox checked>ㅤ위드새내기 1차 정기 회의<br>
            </td>
            <td>
                <span style="color:rgb(218, 139, 139);">❤</span>ㅤC#<br>
                <span style="color:rgb(218, 139, 139);">❤</span>ㅤUnity<br>
...
<table>
    ...
    <tbody>
        <tr>
            <td>
                <input type=checkbox checked>ㅤ절대강좌 유니티 CH2<br>
                <input type=checkbox checked>ㅤ오후 5시 풀씨 자료구조
            </td>
            <td>
                <span style="color:rgb(218, 139, 139);">❤</span>ㅤC#<br>
                <span style="color:rgb(218, 139, 139);">❤</span>ㅤUnity<br>
...
<table>
    ...
    <tbody>
        <tr>
            <td>
                <input type=checkbox checked>ㅤC# CH12<br>
                <input type=checkbox checked>ㅤ이상한 나라의 수학자<br>
            </td>
            <td>
                <span style="color:rgb(218, 139, 139);">❤</span>ㅤC#<br>
                <span style="color:rgb(218, 139, 139);">❤</span>ㅤUnity<br>
